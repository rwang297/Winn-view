    ...
    <section className="py-20 lg:py-32 px-6 bg-blue-50">
      <div className="w-full px-6 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 auto-rows-[minmax(200px,auto)]">
          ...
          <div className="md:col-span-2 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl p-8 group hover:shadow-lg transition-all duration-500 text-white">
            <TrendingUp size={32} className="mb-6 text-white" />
            <h3 className="text-xl font-bold mb-2">High Yield</h3>
            <p className="text-white/90">
              Earn up to 4.5% APY on your savings account.
            </p>
          </div>

          {/* Wide Card 6 - Support */}
          <div className="md:col-span-4 bg-white rounded-xl shadow-md p-10 flex flex-col md:flex-row items-center gap-8 group hover:shadow-lg transition-all duration-500 relative overflow-hidden">
            ...
            <div className="flex -space-x-4">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="w-16 h-16 rounded-full border-4 border-white bg-white shadow-lg overflow-hidden"
                >
                  <img
